<%@ Page Title="" Language="C#" MasterPageFile="~/salesMng.Master" AutoEventWireup="true" CodeBehind="EditMaster.aspx.cs" Inherits="SalesMngTool.Page.EditMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <my:header ID="header" runat="server" />
        <p>
            <asp:Label ID="Label_MasterEdit" runat="server" Text="マスタ編集"></asp:Label>
    </p>
        <p>
        ...
        <p>
            <asp:Button ID="Button_Edit" runat="server" Text="更新" OnClick="Button_Edit_Click"/>
            <asp:Button ID="Button_Delete" runat="server" Text="削除" OnClick="Button_Delete_Click"/>
        </p>
</asp:Content>
