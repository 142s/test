<%@ Page Title="" Language="C#" MasterPageFile="~/salesMng.Master" AutoEventWireup="true" CodeBehind="EditHistCon.aspx.cs" Inherits="SalesMngTool.Page.EditHistCon" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="Label1" runat="server" Style="text-align: center" Text="連絡履歴登録"></asp:Label>
    ...
    <br />
    <br />
    <asp:Button ID="BtnEntry" runat="server" Text="更新" OnClick="BtnEntry_Click" Height="33px" Width="100px" />
    <asp:Button ID="BtnDel" runat="server" Height="33px" OnClick="BtnDel_Click" Text="削除" Width="100px" />
    <br />
